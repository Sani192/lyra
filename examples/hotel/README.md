...
This example shows how Lyra can orchestrate a hotel conversation without becoming the system of record. The consumer application owns domain data, policies, and final business decisions.
