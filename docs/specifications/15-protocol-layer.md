...
This chapter covers platform expectations, terminology, boundaries, and future requirement details related to protocol layer. It does not define executable implementation.
