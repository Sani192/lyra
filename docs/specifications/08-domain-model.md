...
Define the domain model area of Lyra so contributors share a stable, documented understanding before implementation.

## Scope

This chapter covers platform expectations, terminology, boundaries, and future requirement details related to domain model. It does not define executable implementation.
